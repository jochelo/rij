    ...
    <div class="col-lg-6 offset-md-2">
        <div class="card">
            <div class="card-header">
                <strong>Datos</strong> Reporte <strong>PDF</strong>
            </div>
            <form action="{{ route('storeR') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-8 offset-md-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-file"></i> Continuar
                            </button>
